...
\item En la programación imperativa/procedural: en cada paso se comprueba el estado concreto en ese momento de tal y tal y tal para, en función de ello, realizar alguna acción; acción que modificará cual o cual o cual.

\item En la programación orientada a objeto: en cada paso se utiliza el objeto pertinente, para pedirle que haga algo.

\item En la programación funcional: en cada paso se llama a la función pertinente, para transformar de esto que se le pasa como parámetros a lo que se obtiene como resultado devuelto.

\end{itemize}

En las seguientes secciones se verá cada uno de estos paradigmas con un poco más de detalle.
...
El formalismo teórico tras este tipo de programación funcional es $\lambda-calculus o \pi-calculus$
