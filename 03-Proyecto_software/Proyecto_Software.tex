...
\item En la programación funcional: en cada paso se llama a la función pertinente, para transformar de lo que se tiene en ese momento a lo que se desea tener.
