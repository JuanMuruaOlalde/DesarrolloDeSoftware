...
\includegraphics[width=4cm]{portada-MasteringReguarExpressions-JeffreyEFFriedl.jpg} 
...
\includegraphics[width=4cm]{portada-IloveLogs-JayKreps.jpg} 
...
\chapter{apéndice: un repaso rápido sobre algunos conceptos importantes.}
