...
\subsection{Los ``imprescindibles''}

Si solo vas a leer unos pocos, empieza por estos:
...
``Código limpio: manual de estilo para el desarrollo ágil de software '' • Robert C. Martin (aka ``uncle Bob'') • Anaya Multimedia (2012)
...
``Arquitectura limpia: guía para especialistas en la estructura y el diseño de software '' • Robert C. Martin (aka ``uncle Bob'') • Anaya Multimedia (2018)
