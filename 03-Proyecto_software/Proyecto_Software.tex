...
\includegraphics[width=\textwidth]{encapsulacion en paradigma de objetos}

\item Los que son funcionales lo definen a través de ``closures'' en funciones factoria.
\includegraphics[width=\textwidth]{encapsulacion en paradigma funcional}

\item Los que son distribuidos lo consiguen a través de mensajes que unos elementos emiten y otros elementos leen.
