...
\begin{itemize}
\item Atomicity $\rightarrow$ transacciones todo/nada
\item Consistence $\rightarrow$ preservar los invariantes del sistema
\item Isolation $\rightarrow$ determinismo en las operaciones realizadas
\item Durability $\rightarrow$ si algo está hecho, no puede "perderse"
\end{itemize}

La concurrencia, el paralelismo o la distributividad son mucho más sencillos si se puede evitar garantizar ACID en todo momento y si se puede evitar la competencia por recursos exclusivos.
